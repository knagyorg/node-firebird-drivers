...
import { Blob, BlobSeekWhence, CreateBlobOptions } from '@knagyorg/node-firebird-driver';
import { AbstractBlobStream, blobInfo, createBpb, getPortableInteger } from '@knagyorg/node-firebird-driver/dist/lib/impl';
